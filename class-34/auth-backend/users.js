...
users.authenticateToken = async function (token) {
  try {
    ...
    //   what gives this an expiration is a timestamp on the encoded token
    //   This get's stored primarily in the browser / user-agent / client.
...
users.generateToken = function (user) {
  ...
  // this is the ONLY place that a token is created
  //  it encodes useData
